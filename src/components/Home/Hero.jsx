    ...
    <header className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <section className="relative z-10 max-w-7xl mx-auto px-6 pt-20 pb-24">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          >
            {/* 🔥 BUTTON ACTIVATED: Yeh link click pe 404 nahi dega */}
            <button
              onClick={onBuildClick}
              className="bg-green-600 hover:bg-green-700 px-8 py-4 rounded-full font-semibold shadow-lg shadow-green-500/20 transition cursor-pointer"
            >
              Build Resume Free
            </button>

            {/* Smooth scroll to templates wrapper */}
            <a
              href="#templates"
              className="border border-white/10 hover:border-green-500 px-8 py-4 rounded-full transition flex items-center justify-center"
            >
              Explore Templates
            </a>
          </motion.div>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-12">
            <div className="bg-white/5 backdrop-blur-xl px-6 py-4 rounded-2xl border border-white/10">
              <h3 className="text-3xl font-bold text-green-500">50K+</h3>
              <p className="text-gray-400">Resume Generated</p>
            </div>

            <div className="bg-white/5 backdrop-blur-xl px-6 py-4 rounded-2xl border border-white/10">
              <h3 className="text-3xl font-bold text-green-500">94%</h3>
              <p className="text-gray-400">ATS Success Rate</p>
            </div>

            <div className="bg-white/5 backdrop-blur-xl px-6 py-4 rounded-2xl border border-white/10">
              <h3 className="text-3xl font-bold text-green-500">10K+</h3>
              <p className="text-gray-400">Interviews Landed</p>
            </div>
          </div>
            ...
            <div className="w-full max-w-md bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl p-6 hover:scale-105 transition-all duration-500 shadow-[0_0_60px_rgba(34,197,94,0.2)]">
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  <h3 className="font-semibold text-lg">Priya Kumari</h3>
          ...
          <div className="mt-10 flex justify-center">
            <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-5 max-w-sm text-left">
              <p className="text-green-400 font-semibold mb-3">🤖 AI Suggestions</p>
          ...
          <div className="mt-20 flex flex-wrap justify-center gap-4">
            <div className="bg-white/5 px-5 py-3 rounded-full border border-white/10">⚡ AI Resume Builder</div>
            <div className="bg-white/5 px-5 py-3 rounded-full border border-white/10">📄 ATS Optimized</div>
            <div className="bg-white/5 px-5 py-3 rounded-full border border-white/10">🎯 Job Matching</div>
            <div className="bg-white/5 px-5 py-3 rounded-full border border-white/10">💼 Cover Letter AI</div>
            <div className="bg-white/5 px-5 py-3 rounded-full border border-white/10">🚀 Instant Export</div>
          </div>

          {/* Trusted Companies */}
          <div className="mt-20">
            <p className="text-gray-500 mb-6">Trusted by candidates applying to</p>
